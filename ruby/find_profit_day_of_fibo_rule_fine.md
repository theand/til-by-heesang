...
TIL 모임에서 12월에는 결석일수에 따른 벌금제도에 피보나치 수를 적용하기로 했다. n번째 결석일의 벌금이 피보나치 수에 규칙에 따라 증가하는 것이다. 그렇다면 결석일수에 따른 월 총 벌금액은 기존의 하루 1000원으로 고정된 벌금제도와 비교해서 어느 구간이 `개이득` 인지 궁금해져서 찾아봄.
